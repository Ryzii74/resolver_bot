const Index = {
    ...
    meta2: { exec: require('../../commands/metagramma2'), name: 'Метаграммы 2 буквы' },
    ...
    plus2: { exec: require('../../commands/plus2'), name: 'Плюсограмма 2 буквы' },
    ...
    regions: { exec: require('../../commands/regions'), name: 'Регионы России' },
};
