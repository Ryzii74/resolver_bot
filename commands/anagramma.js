...
module.exports = async (msg) => {
    ...
    msg.addAnswersResponse(wordPairs.map(([w1, w2]) => `${w1} ${w2}`), undefined, 'Пары слов');
    msg.addAnswersResponse(correctWords, undefined, 'Одно слово');
};
...
function isAnagramCombo(text, wordsArray) {
    ...
    for (let i = 0; i < validWords.length; i++) {
        ...
        console.log(word1, remainingLetters)
